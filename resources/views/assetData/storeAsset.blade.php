<div class="modal fade modalStoreAssetGen" tabindex="-1" aria-labelledby="modalStoreAssetGenLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalStoreAssetGenLabel">เพิ่มข้อมูลทรัพย์สินใหม่ของบริษัท</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{ route('assetData.storeAsset') }}" method="POST" enctype="multipart/form-data">
                    @csrf
